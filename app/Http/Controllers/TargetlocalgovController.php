...
class TargetlocalgovController extends Controller
{
    public function index()
    {
        ...
        $violences = DB::table('wp_postmeta')
            ...
            ->where('wp_postmeta.meta_key', '_content_field_236')
            ->get();
